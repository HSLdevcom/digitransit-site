...
| `transport_mode` | The type of the vehicle. One of `bus`, `tram`, `train`, `ferry` or `metro`.<br/>**Note:** Currently only buses, trams and trains provide vehicle positions. Data for metros will be available later.
