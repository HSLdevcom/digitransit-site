...
| `event_type`     | One of `vp`, `due`, `arr`, `dep`, `ars`, `pde`, `pas`, `pas`, `wait`, `doo`, `doc`, `tlr`, `tla`, `da`, `dout`, `ba`, `bout`, `vja`, `vjout`.<br/>See descriptions for these values [below](#event-types).
