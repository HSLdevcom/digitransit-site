...
### Plan an itinerary with via locations

There are two types of via locations: pass-through via locations and visit via locations. With pass-through
...
#### Plan an itinerary with visit via locations
...
```graphql
{
  planConnection(
    ...
    via: [ {
       visit:  {
          coordinate:  {
             latitude: 60.1950122434621
             longitude: 24.9390506744384
          }
       }
    },
    {
