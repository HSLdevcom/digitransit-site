...
import { DockerInfo, TechnologiesInfo, Assets, ArchitectureHeader, ReplitEmbed } from '../components/components';
            ...
            <Breakpoint minWidth={700}>
              <div>
                ...
                >
                  ...
                  <ArchitectureHeader slug={props.data.markdownRemark.fields.slug} {...props.data.markdownRemark.frontmatter}/> 
                  <Markdown {...props} />
...
query($slug: String!) {
  childPages: allMarkdownRemark(filter: {fields: {slug: {regex: "/en/developers/"}}}) {
    edges {
      node {
        fields  {
          slug
